    ...
    <div className={`message message-${msg.role}`} data-mid={msg.id}>
      ...
      <div className="message-content">
        ...
        <div className="message-footer">
          <span className="message-timestamp" title={new Date(msg.timestamp).toLocaleString(en ? 'en-US' : 'pt-BR', { dateStyle: 'medium', timeStyle: 'short' })}>{new Date(msg.timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
