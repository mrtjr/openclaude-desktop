...
// ─── Types ────────────────────────────────────────────────────────────────────
// Persona/Provider + as built-ins vivem num módulo LEVE de dados (sem React) p/
// o App montar a lista completa sem puxar este componente lazy ao bundle
// principal (fusão do PersonaEngine no chat, v2.77.0).
import { BUILTIN_PERSONAS, type Persona, type Provider } from './constants/builtinPersonas'
