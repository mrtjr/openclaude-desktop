    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          auto: { type: 'boolean', description: 'Let the AI decide which skills to download (default false). Set true when the user did NOT name specific skills and wants you to choose: installs new skills, upgrades existing ones only if more complete (evolution, never regression), within a ~60s budget. Also enables auto-sweeping an awesome-* index repo.' }
        },
        required: ['repo']
      }
    }
